...
"font-weight: bold;"));
        ...
        SingleMenuButton = new QPushButton(GameSettingsScreen);
        SingleMenuButton->setObjectName(QString::fromUtf8("SingleMenuButton"));

        gridLayout_3->addWidget(SingleMenuButton, 0, 0, 1, 1);
...
"font-weight: bold;"));
    ...
    void retranslateUi(QMainWindow *MainMenu)
    {
        ...
        SingleMenuButton->setText(QCoreApplication::translate("MainMenu", "Main Menu", nullptr));
